...
public class SSSearch extends SearchParameters {
	...
	private static final long serialVersionUID = -2842593962837470157L;
	private List<String> negativeTagMatch;

	public SSSearch() {
		this.negativeTagMatch = new ArrayList<>();
	...
	/* Not sure if this is required; seems to never be used. -- jb */
//	/**
