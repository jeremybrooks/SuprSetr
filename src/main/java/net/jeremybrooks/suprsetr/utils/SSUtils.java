...
public class SSUtils {
	...
	Collections.sort(list, new PhotoTitleComparatorDescending());
    }
	...
	Collections.sort(list, new PhotoTitleComparatorAscending());
    }
     ...
     */
    static class PhotoTitleComparatorAscending implements Comparator<Photo> {
    ...
    static class PhotoTitleComparatorDescending implements Comparator<Photo> {
